...
<p align="center">Aplicação focada no consumo de Api's externas, Framework Next.js, CMS e FaunaDB </p>
...
$ git clone https://github.com/Filipey/ignews.git
...
# Execute o Event Listener do Stripe no terminal
